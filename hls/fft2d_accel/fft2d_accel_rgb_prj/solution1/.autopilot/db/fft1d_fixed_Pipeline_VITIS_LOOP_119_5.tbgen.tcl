set moduleName fft1d_fixed_Pipeline_VITIS_LOOP_119_5
set isTopModule 0
...
set cdfgNum 18
set C_modelName {fft1d_fixed_Pipeline_VITIS_LOOP_119_5}
...
set C_modelArgList {
	{ select_ln119 int 31 regular  }
	{ len int 32 regular  }
	{ empty_43 int 6 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "select_ln119", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	{ "Name" : "len", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "empty_43", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ select_ln119 sc_in sc_lv 31 signal 0 } 
	{ len sc_in sc_lv 32 signal 1 } 
	{ empty_43 sc_in sc_lv 6 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "select_ln119", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "select_ln119", "role": "default" }} , 
 	{ "name": "len", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "len", "role": "default" }} , 
 	{ "name": "empty_43", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "empty_43", "role": "default" }} , 
...
set Spec2ImplPortList { 
	select_ln119 { ap_none {  { select_ln119 in_data 0 31 } } }
	len { ap_none {  { len in_data 0 32 } } }
	empty_43 { ap_none {  { empty_43 in_data 0 6 } } }
