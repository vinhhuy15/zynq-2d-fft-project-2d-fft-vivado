...
$channels = @("r", "g", "b")
$csvPath = "results/hls_prep_color_accuracy_64x64.csv"
...
foreach ($sample in $samples) {
    ...
    $outRealPaths = $channels | ForEach-Object { "${sample}_64x64_${_}_hls_prep_fft_real_2d.txt" }
    $outImagPaths = $channels | ForEach-Object { "${sample}_64x64_${_}_hls_prep_fft_imag_2d.txt" }
