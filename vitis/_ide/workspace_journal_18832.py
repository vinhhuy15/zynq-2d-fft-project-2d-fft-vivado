...
platform = client.create_platform_component(name = "fft_platform",hw_design = "$COMPONENT_LOCATION/../../vivado_2d_FFT/fft_rgb.xsa",os = "standalone",cpu = "ps7_cortexa9_0",domain_name = "standalone_ps7_cortexa9_0",compiler = "gcc")
