...
// ==============================================================
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module fft2d_fixed_top_CTRL_s_axi
#(parameter
...
localparam
    ...
    ADDR_OUTPUT_REAL_DATA_0 = 6'h1c,
    ADDR_OUTPUT_REAL_DATA_1 = 6'h20,
    ADDR_OUTPUT_REAL_CTRL   = 6'h24,
    ADDR_OUTPUT_IMAG_DATA_0 = 6'h28,
    ADDR_OUTPUT_IMAG_DATA_1 = 6'h2c,
    ADDR_OUTPUT_IMAG_CTRL   = 6'h30,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    WRRESET                 = 2'd3,
